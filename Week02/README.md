# Mission Log 02 - Ubuntu 24.04 And ROS2 Environment Setup

> Mission focus: this week focused on installing the Linux and ROS2 environment, then verifying the setup with the classic turtlesim demo.
